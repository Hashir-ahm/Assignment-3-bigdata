...
for message in consumer_instance:
    ...
    counter_var += 1  # Increment counter
    print("\n\n\n\n\n\n\n\n\n\n\n\n\nConsumer run:", counter_var)  # Print current count
...
# Count occurrences of each item pair
for item_pair in item_pairs:
    ...
    if count_val >= threshold_val:
        ...
        pairs_list2.append(item_pair)  # Add item pair to pairs_list2

print("\n\n\n\n\n\n\n\n\Pair Counts:", pair_count_list)  # Print pair_count_list
